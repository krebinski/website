...
import MafakaIcon from "@/assets/brand/mafaka.svg";
...
const Home: NextPage<ProjectProps> = ({ project }) => {
  ...
  return (
    <>
      <SEO
        title={t("title.index")}
        description="MafakaMC é uma organização de software Minecraft focada em melhorar
          o ecossistema do jogo com software mais rápido e seguro."
        keywords={["mafakamc", "mafaka", "minecraft", "vanilla"]}
      />
