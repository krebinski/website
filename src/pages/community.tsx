...
const CommunityIndex: NextPage = () => (
  <>
    <SEO
      ...
      description="Estamos felizes em ter você como parte da comunidade MafakaMC!Estamos felizes em ter você como parte da comunidade MafakaMC!"
      keywords={["mafakamc", "mafaka", "minecraft", "sponsor", "community"]}
    />
