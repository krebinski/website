...
const Team: NextPage = () => {
  ...
  return (
    <>
      <SEO
        title={t("title.team")}
        description="Conheça a equipe por trás da MafakaMC, uma organização de software Minecraft focada em melhorar
            o ecossistema do jogo com software mais rápido e seguro."
        keywords={["mafakamc", "mafaka", "minecraft", "team"]}
      />
                  ...
                  <div className="min-w-0 flex-1 break-all">
                    ...
                    {member.github && (
                      <a
                        ...
                        className="flex flex-row items-center gap-2 mt-2 text-purple-800 dark:text-purple-300 text-sm font-medium"
                        rel="noreferrer"
                        target="_blank"
                      >
                    ...
                    {member.discord && (
                      <div className="flex flex-row items-center gap-2 mt-1 text-purple-800 dark:text-purple-300 text-sm font-medium">
