        ...
        >
          {build &&
            Object.entries(build.downloads).map(([name, download]) => (
              <Menu.Item key={name}>
                {() => (
                  <div className="hover:bg-purple-100 dark:hover:bg-gray-800 transition-colors">
                    {/* eslint-disable-next-line react/jsx-no-target-blank */}
                    <a
                      href={
                        projectId &&
                        ...
                        <div className="font-medium">
                          ...
                          {download.sha256 !== null &&
                            copied === download.sha256 && (
                              <span className="ml-2 text-xs rounded-full py-0.5 px-2 bg-purple-200/80 text-purple-800">
                                {t(
